...
public class CarrinhoController {
    ...
    public void controlCarrinho(@RequestParam("id") String idProduto, @RequestParam("comando") String comando, HttpServletRequest request,
        ...
        if (comando.equals("add")) {
            ...
            Cookie cookieToDelete = new Cookie(nomeCarrinho, null); // Cria um novo cookie com o mesmo nome do cookie a ser destruído
            cookieToDelete.setMaxAge(0); // Define o tempo de vida do cookie como zero para que ele expire imediatamente
            response.addCookie(cookieToDelete); // Adiciona o cookie à resposta HTTP para que ele seja removido pelo navegador
    ...
    public void controlCarrinhoFromVerCarrinho(@RequestParam("id") String idProduto, @RequestParam("comando") String comando,
        ...
        if (comando.equals("add")) {
            ...
            // Se encontrar o idProduto na string idProdutos, remove
            if (index != -1) {
