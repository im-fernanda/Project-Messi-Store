...
public class VerCarrinhoController {
    ...
    public void getCarrinho(HttpServletRequest request, HttpServletResponse response)
        ...
        // Método para recuperar lista de produtos do carrinho a partir do cookie
...
//            writer.println("<td>" + item.getDescricao() + "</td>");
...
//            writer.println("<td><a href='/carrinhoServlet?id=" + item.getId() + "&comando=remove'>Remover</a></td>");
//            writer.println("</td>");
//            writer.println("</tr>");
//        }
